...
import { Plus, X, Copy, Download, Code2, Database, Layers, Zap, Settings, Bell, HelpCircle, Wand2 } from 'lucide-react';
    ...
    <div className="flex h-screen bg-ui-base">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="flex-1 flex overflow-hidden min-h-0">
          ...
          {/* Right Sidebar - Program Flow Analysis */}
          {activeTab === 'design' && nodes.length > 0 && (
